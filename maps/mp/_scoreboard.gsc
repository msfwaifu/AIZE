...
setPlayerScoreboardInfo()
{
	...
	{
		setClientMatchData( "players", self.clientMatchDataId, "money", self.money );
		println( "Scoreboard: [" + self.name + "(" + self.clientMatchDataId + ")][money]: " + self.money );
		...
		setClientMatchData( "players", self.clientMatchDataId, "assists", self.revives );
		println( "Scoreboard: [" + self.name + "(" + self.clientMatchDataId + ")][assists]: " + self.revives );
